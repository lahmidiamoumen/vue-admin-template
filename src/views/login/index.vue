  ...
  <div class="login-container">
    <el-form ref="loginForm" :model="loginForm" :rules="loginRules" class="login-form" auto-complete="on" label-position="left">
      ...
      <div class="title-container">
        <h3 class="title">La gestion des essais cliniques</h3>
      </div>
      ...
      <el-button :loading="loading" type="primary" style="width:100%;margin-bottom:5px;" @click.native.prevent="handleLogin">Connexion</el-button>
    </el-form>
...
export default {
  ...
  data() {
    const validateUsername = (rule, value, callback) => {
      if (value.length < 6) {
        callback(new Error("Veuillez saisir le nom d'utilisateur correct"))
      } else {
        callback()
      }
    }
